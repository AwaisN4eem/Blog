    ...
    <>
      ...
      <div className="w-full flex justify-center items-center h-[80vh] ">
        <div className="flex flex-col justify-center items-center space-y-4 w-[80%] md:w-[25%]">
          ...
          <input onChange={(e) => setPassword(e.target.value)} className="w-full px-4 py-2 border-2 border-black outline-0" type={passwordVisible ? "text" : "password"} placeholder="Enter your password" />
          <button onClick={handlePasswordVisibility} className="text-sm text-blue-500">
